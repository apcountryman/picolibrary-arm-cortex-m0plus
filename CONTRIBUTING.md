# Contributing to picolibrary-arm-cortex-m0plus
The following is a set of guidelines for contributing to `picolibrary-arm-cortex-m0plus`.
...
- The `picolibrary-arm-cortex-m0plus` version (Git commit SHA)
